...
class DiffusionTrainingModule(torch.nn.Module):
    ...
    def configure_swiftfusion_lora(
        self,
        pipe,
        target_modules,
        rank,
        ...
        pipe.freeze_except([])
        pipe.dit = self.add_lora_to_model(
            pipe.dit,
...
class ModelLogger:
    ...
    def _state_dict(self, accelerator, model):
        ...
        return unwrapped.export_trainable_state_dict(
            state_dict,
    ...
    def save_model(self, accelerator, model, file_name):
        ...
        accelerator.save(
            self._state_dict(accelerator, model),
